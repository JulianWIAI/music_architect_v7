# ============================================================
#  Generation 2  -  100 evolutionary tracks per genre
#  Seed pool: Top-5 Golden Matrices from Generation 1
#  Mutation factor: 0.05 (5% variance)
# ============================================================

$Root   = $PSScriptRoot
$Gen1   = Join-Path $Root "Generation1"
$OutDir = Join-Path $Root "Generation2"
$Python = "python"
...
if (Test-Path $OutDir) {
    Write-Host "Removing old Generation2..." -ForegroundColor Yellow
...
foreach ($g in $Genres) {
    ...
    if (Test-Path $SeedPool) {
        ...
        Write-Host "  [WARN] No Gen1 report - free exploration" -ForegroundColor Yellow
    }
...
# ── Pure Math Grader ─────────────────────────────────────────
Write-Host ""
Write-Host "Running Pure Math Grader on Generation2..." -ForegroundColor Magenta
