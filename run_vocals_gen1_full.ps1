# ============================================================
#  Vocals Generation 1  -  100 tracks per genre
#  Mode: free exploration  |  Vocal mask: ON
# ============================================================

$Root   = $PSScriptRoot
$OutDir = Join-Path $Root "vocals_generation_1"
$Python = "python"
...
if (Test-Path $OutDir) {
    Write-Host "Removing old vocals_generation_1..." -ForegroundColor Yellow
...
# ── Pure Math Grader ─────────────────────────────────────────
Write-Host ""
Write-Host "Running Pure Math Grader on vocals_generation_1..." -ForegroundColor Magenta
