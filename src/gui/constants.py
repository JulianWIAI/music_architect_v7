...
ROLE_INSTRUMENTS = {
    ...
    # Short percussive hits and brass/synth bursts — ideal for stab patterns
    'stabs':   [55, 48, 49, 50, 56, 61, 62, 63, 80, 81, 0, 52],
    # Sustained layers and evolving pads — fills out the texture bed
    'texture': [88, 89, 90, 91, 92, 93, 94, 95, 97, 98, 99, 51, 54],
    # GM FX bank (programs 96–103) — rain, crystal, atmosphere, sci-fi, etc.
