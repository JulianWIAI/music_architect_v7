# ============================================================
#  Trap / Hip-Hop  VOCAL MASK  --  Generation 2
#  250 Trap + 250 Hip-Hop  |  Top-5 seeds from Vocals Gen1, mutation 0.05
# ============================================================

$Root   = $PSScriptRoot
$Gen1   = Join-Path $Root "trap_hiphop_vocals_gen1"
$OutDir = Join-Path $Root "trap_hiphop_vocals_gen2"
$Python = "python"
...
if (Test-Path $OutDir) {
    Write-Host "Removing old trap_hiphop_vocals_gen2..." -ForegroundColor Yellow
...
# ---- Pure Math Grader -------------------------------------------------------
Write-Host ""
Write-Host "Running Pure Math Grader on Vocals Generation 2..." -ForegroundColor Magenta
...
Write-Host ""
Write-Host "Next step: run_trap_hiphop_vocals_gen3.ps1" -ForegroundColor Yellow
