# ============================================================
#  Trap / Hip-Hop  —  Generation 1  (Baseline Matrix)
#  100 Trap + 100 Hip-Hop  |  Free exploration, no seeds
# ============================================================

$Root   = $PSScriptRoot
$OutDir = Join-Path $Root "trap_hiphop_gen1"
$Python = "python"
...
if (Test-Path $OutDir) {
    Write-Host "Removing old trap_hiphop_gen1..." -ForegroundColor Yellow
...
# ── Pure Math Grader ─────────────────────────────────────────
Write-Host ""
Write-Host "Running Pure Math Grader on Generation 1..." -ForegroundColor Magenta
...
Write-Host ""
Write-Host "Next step: run_trap_hiphop_gen2.ps1" -ForegroundColor Yellow
